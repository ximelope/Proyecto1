...
public class Escultura extends Pieza{
	...
	public Escultura(String tipo, String titulo, int ano, String lugarCreacion, String autor, boolean exhibida,
			boolean permisoSubasta, int valorFijo, int valorMinimoSubasta, Propietario propietario,String fechas, String propietarios, String precios,  float alto, float ancho,
