...
public class InterfazHistoriaA extends JFrame implements ActionListener {
	private JTextField nameField;
	private JButton submitButton ;
	private Usuario usuario;
	private Galeria galeria; 
	
	public InterfazHistoriaA(Usuario usuario, Galeria galeria) {
		...
		JLabel menu = new JLabel("Historia de un Artista");
        ...
        JLabel nameLabel = new JLabel("Nombre del Artista:");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == submitButton) {
            ...
            String respuesta = usuario.historiaArtista(galeria.getArtistas().get(username));
